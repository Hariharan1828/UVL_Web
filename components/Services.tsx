  ...
  return (
    <section className='p-8 md:p-16'>
      ...
      {services.map((service)=>(
        <>
        {((service.id+1)%2==0)?(
        <div key={service.id} className="flex flex-col xl:flex-row items-center justify-between mb-20 md:mb-10 ">
          <div key={service.id+service.image} className="mx-auto xl:mx-0 mb-20 xl:mb-0 w-[200rem]">
          ...
          <div key={service.id} className="flex flex-col xl:flex-row items-center justify-between mb-20 md:mb-40 ">
